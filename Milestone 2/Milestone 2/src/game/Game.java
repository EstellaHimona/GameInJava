...
public class Game {
    ...
    private final YellowPenguinController controller;
    ...
    public Game() {
        ...
        view = new GameView(this, level, 550, 350);
        view.setZoom(20);
        ...
        controller = new YellowPenguinController(level.getYellowPenguin());
        view.addKeyListener(controller);

        PenguinCoffeeController pcController = new PenguinCoffeeController(level.getPenguinCoffee());
        ...
        JFrame frame = new JFrame("Club Penguin Bean Counters");
        frame.add(view);
    ...
    public void goToNextLevel(){
        ...
        if (level instanceof Level1){
            ...
            controller.updateYellowPenguin(level.getYellowPenguin());
